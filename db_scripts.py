...
#order matters!!!
ALL_SCRIPTS = [CREATE_CHATS, CREATE_SENDERS, CREATE_MESSAGE_TYPES, CREATE_BOOKMARKS, CREATE_TAGS, CREATE_TAGS_TO_BOOKMARKS, CREATE_MESSAGES, TRIGGER_BOOKMARKS_INSERT_1, TRIGGER_BOOKMARKS_INSERT_2, TRIGGER_BOOKAMARKS_INSERT_3, INSERT_INTO_CHATS, INSERT_INTO_SENDERS]
